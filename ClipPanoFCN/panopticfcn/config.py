...
def add_panopticfcn_config(cfg):
    ...
    cfg.MODEL.TRAIN_CLIPNUM = 2
    cfg.MODEL.DILATIONS = [6,12,18]
    cfg.MODEL.USE_CLIPFUSE =True
    cfg.MODEL.TEMPORAL_KERNAL=True
    ...
    cfg.INPUT.TRAIN_SHUFFLE_TIMES = 3
    cfg.TEST.COST_THRESHOLD = 0.3
    cfg.TEST.MEM_WEIGHT = 0.8
    cfg.TRAIN = CN()
    cfg.TRAIN.USE_CON_LOSS = False
